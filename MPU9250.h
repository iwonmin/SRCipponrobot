...
{
    DigitalIn sdaDummy(sda,PullUp);
    DigitalIn sclDummy(scl,PullUp);
    i2c_ = new I2C(sda, scl);
    i2c_ ->frequency(400000);
}

//******************************************************************************
    MPU9250(I2C *i2c):i2c_(i2c){}
...
void MadgwickQuaternionUpdate()
{
    ...
    roll = atan2(2.f*(q[2]*q[3] + q[1]*q[0]),1-2.f*(q[1]*q[1] + q[2] * q[2])) * 180.f/PI;
    pitch = 2 * atan2(sqrt(1+2.f*(q[0]*q[2] - q[1]*q[3])), sqrt(1-2.f*(q[0]*q[2] - q[1]*q[3]))) * 180.f/PI;
    yaw = atan2(2.f*(q[1]*q[2] + q[3]*q[0]), 1-2.f*(q[2]*q[2] + q[3]*q[3])) * 180.f/PI;
}
...
void MahonyQuaternionUpdate()
    {
        ...
        roll = atan2(2.0f * (q2 * q4 + q1 * q3), q1 * q1 + q2 * q2 - q3 * q3 - q4 * q4) * 180.f/PI;
        pitch = asin(-2.0f * (q2 * q3 - q1 * q4)) * 180.f/PI;
        yaw = atan2(2.0f * (q3 * q4 + q1 * q2), q1 * q1 - q2 * q2 - q3 * q3 + q4 * q4) * 180.f/PI;
    }
};
#endif